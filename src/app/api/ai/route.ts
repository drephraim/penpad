  ...
  try {
    ...
    if (action === "continue") {
      ...
      const chapterScanRule = isAdHocMode
        ? "1. PRIORITIZE THE WRITER'S SPECIFIC DETAILS (CRITICAL): The author's story text is the ultimate source of truth. You MUST carefully scan the Full Active Chapter Context and Highlighted Passage to extract all visual details. For characters: hair, facial hair, ethnic/cultural descent, height, age, attire, weapons. For environments/planets/items: layout, architecture, materials, color, scale, atmosphere, celestial features (e.g. rings for a planet). Do NOT omit or contradict these.\n"
        : (isCharacterLike
          ? "1. PRIORITIZE THE WRITER'S SPECIFIC DETAILS (CRITICAL): The author's story text is the ultimate source of truth. You MUST carefully scan the Full Active Chapter Context, Highlighted Passage, and Story Bible to extract seven core visual pillars: HAIR, FACIAL HAIR, ETHNIC/CULTURAL DESCENT, HEIGHT, AGE, ATTIRE, and WEAPONS/HELD ITEMS. Do NOT omit, modify, or contradict any of these. If the chapter describes them, they MUST be the foundation of the generated prompts:\n" +
            ...
            "2. BUILD PROMPT AROUND WRITTEN DETAILS: Always write the prompt such that the written details are the primary focus of the character's description. The prompt must be built around their hair, facial hair, ethnic descent/culture, height, age, attire, and weapon. Avoid letting generic templates or your own assumptions overwrite the author's words.\n" +
