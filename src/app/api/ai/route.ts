  ...
  try {
    ...
    if (action === "continue") {
      ...
      systemInstruction =
        ...
        "10. Detect reincarnation and past-life information intelligently. Trigger this when the chapter uses phrases such as incarnation, incarnations, reincarnation, past life, past lives, previous life, former life, life as, in her life as, in his life as, when she was, when he was, she had once been, he had once been, soul memory, former self, previous self, prior existence, or names/titles explicitly framed as an earlier identity. Store this in profile.customFields['Incarnation / Past Lives'] as a concise readable summary. Also fill profile.customFields['Incarnation / Past Lives Identity/Name'], profile.customFields['Incarnation / Past Lives Era'], and profile.customFields['Incarnation / Past Lives Fate/Legacy'] when those parts can be inferred. Preserve multiple past lives separated by semicolons. Do not confuse ordinary aliases, disguises, family ancestry, titles, or metaphors with a real past life unless the chapter frames it as a previous incarnation or former life.\n" +
